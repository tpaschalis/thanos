...
type UnaryClient interface {
	Rules(ctx context.Context, req *rulespb.RulesRequest) ([]*rulespb.RuleGroup, storage.Warnings, error)
}
...
func (rr *GRPCClient) Rules(ctx context.Context, req *rulespb.RulesRequest) ([]*rulespb.RuleGroup, storage.Warnings, error) {
